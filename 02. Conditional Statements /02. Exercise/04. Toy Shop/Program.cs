...
//Calculations
double toysBill = (puzzlePrice * puzzlesCount) + (dollPrice * dollsCount) +
    (bearPrice * bearsCount) +
...
if (toysCount >= 50)
{
    toysBill = toysBill * 0.75; //toysBill = toysBill-(toysBill- 0.25)
}

double shopRent = toysBill * 0.10;
double finalBill = toysBill - shopRent;
...
{
    double remainingMoney = excursionPrice - finalBill;
